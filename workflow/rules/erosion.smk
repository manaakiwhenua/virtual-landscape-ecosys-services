...
rule landscape_u_values:
    ...
    output:
        temp("results/erosion/{landscape}/{topography}.{landclass}.Landscape_U_Values.tif")
    params:
        datatype="Float64",
    ...
    container:
        "docker://osgeo/gdal:ubuntu-small-latest"
    log:
        "logs/erosion/{landscape}/{topography}.{landclass}.Landscape_U_Values.log"
    shell:
...
rule erosion:
    input:
        ...
        u="results/erosion/{landscape}/{topography}.{landclass}.Landscape_U_Values.tif"
    output:
    ...
    container:
        "docker://osgeo/gdal:ubuntu-small-latest"
    log:
        "logs/erosion/{landscape}/{topography}.{landclass}.LandscapeErosion_t_km_yr.log"
    shell:
